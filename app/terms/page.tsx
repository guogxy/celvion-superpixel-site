...
const zh: LegalContent = {
  ...
  sections: [
    ...
    { heading: '三、相机与处理结果', paragraphs: ['Celvion SuperPixel 提供多帧拍摄、RAW/JPG 处理、MFSR 重建、计算变焦和可选 AI 增强。场景运动、光线、对焦、相机硬件、设备温度、存储空间与设置均会影响结果。', '如果严格“真实超分”拍摄失败，但 App 保留的来源通过了身份、格式、路径、尺寸和质量验证，你可以在作品库主动请求普通 2× AI 补救或原尺寸 AI 降噪。这些是明确标注的单帧 AI 结果，不会增加物理观测、不修复失败的融合记录，也不会变成“真实超分”。', '多帧或 AI 处理可能产生柔化、重影、振铃、过度平滑或不正确的细节观感。输出像素尺寸本身不等于新增真实光学细节；保存、发布或使用重要结果前请仔细检查。', 'App 不保证支持每一款 iPhone、镜头、RAW 模式、场景、图像尺寸或系统版本，也不用于证据保存、科研测量、安全关键用途或任何要求结果准确性得到保证的场景。请保留原片与独立备份。'] },
    ...
    { heading: '七、更新与兼容性', paragraphs: ['App 可能因安全、兼容、性能、法律或产品原因更新、调整、限制或停止部分功能。RAW 与长焦选项会反映所选物理镜头实际报告的能力；可选 AI 处理需要兼容的设备资源，在没有符合条件的融合母版或经验证的单帧补救来源时可能保持不可用。'] },
